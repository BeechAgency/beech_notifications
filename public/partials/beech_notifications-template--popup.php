 ...
 */
?>
<template id="BEECH_notifications--popup">

    <div class="BEECH_notification BEECH_notifications--popup" 
        data-beech-notification-id="" 
        data-beech-notification-days="90"
        data-beech-notification-type="popup"
        >
        <dialog class="BEECH_notifications--popup_dialog" id="">
            <div class="BEECH_notifications--popup_content">
                ...
                <button value="cancel" formmethod="dialog" class="BEECH_notifications--close">
